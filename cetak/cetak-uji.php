...
$file = new PHPExcel ();
    ...
    $file->getProperties ()->setTitle ( "Data Uji" );
    $file->getProperties ()->setSubject ( "Data Uji" );
    $file->getProperties ()->setDescription ( "Data Uji" );
    $file->getProperties ()->setKeywords ( "Data Uji" );
    $file->getProperties ()->setCategory ( "Template Data Uji" );
...
include "../koneksi.php";
    ...
    $result =mysqli_query($koneksi, "SELECT * FROM data_uji ORDER BY id ");
...
/* start - BLOCK MEMBUAT LINK DOWNLOAD*/
    ...
    header ( 'Content-Disposition: attachment;filename="Data Test.xls"' ); 
