...
<div id="print-area-1" class="print-area">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C1</h5>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C2</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C3</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C4</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C5</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C6</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C7</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C8</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C9</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Atribut C10</h5>
                    <table class="table table-sm mb-0" style="text-align:center">
                        <thead class="table-dark">
                            <tr>
                                <th>Kelas</th>
